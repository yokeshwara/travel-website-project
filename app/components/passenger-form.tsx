  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="p-6 bg-secondary border-none">
        <p className="text-sm font-medium mb-4">Log in to your account to unlock extra benefits</p>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-sm font-medium">Save on your booking when you</p>
              <p className="text-sm text-muted-foreground">pay using Cash + Avios</p>
            </div>
          </div>
          <div className="flex items-start gap-3">
            <div className="p-2 bg-card rounded">
            ...
            <div>
              <p className="text-sm font-medium">Auto-fill your travel</p>
      ...
      <Card className="p-6 border-none bg-secondary">
        <h2 className="text-lg font-semibold mb-6">Passenger 1 (Adult)</h2>
        ...
        <div className="mb-6">
          ...
          <div className="flex gap-3">
            ...
            <label className="flex items-center gap-2 cursor-pointer">
              ...
              <span className="text-sm">Mrs</span>
            </label>
            <label className="flex items-center gap-2 cursor-pointer">
        ...
        {/* Travel Documents */}
        <div className="mb-4">
          <h3 className="text-sm font-medium mb-3">Travel Documents</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
      ...
      <Card className="p-6 border-none bg-secondary">
        ...
        {expanded !== 2 && <p className="text-sm text-muted-foreground mt-4 text-center">Expand to add details</p>}
      </Card>
      ...
      <Card className="p-6 border-none bg-secondary">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
          ...
          <div>
            <Label htmlFor="contactcountry" className="text-sm font-medium mb-2 block">
              Select Country
            </Label>
            <div className="relative">
              <select className="w-full px-3 py-2 bg-card border border-border rounded-md text-sm appearance-none">
