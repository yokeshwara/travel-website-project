    ...
    <section className="py-12 sm:py-16 lg:py-60 px-4 sm:px-6 lg:px-8 bg-white">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-8 sm:mb-12">
          ...
          <button className="text-blue-600 hover:text-blue-700 font-medium text-sm hidden sm:block">
            See more places
          </button>
        </div>
        ...
        {/* Mobile button */}
        <button className="sm:hidden mt-6 w-full py-2 text-blue-600 hover:text-blue-700 font-medium border border-blue-600 rounded-lg">
          See more places
        </button>
      </div>
    </section>
