  ...
  return (
    <div className="w-full max-w-5xl px-4">
      ...
      <div className="flex flex-wrap gap-4 mb-8">
        <button  className="bg-white rounded-lg px-6 py-3 flex items-center gap-2 text-blue-600 font-medium shadow-lg hover:bg-gray-50 transition-colors">
          <ArrowLeft size={18} />
          Back
        </button>
      ...
      <div className="bg-white rounded-2xl rounded-tl-none p-8 md:p-12 shadow-2xl relative">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          {/* <div className="flex flex-col gap-8">
            ...
            <button onClick={clickNext}className="bg-blue-600 text-white w-full py-4 rounded-lg font-bold text-lg hover:bg-blue-700 transition-colors">
              Next 
            </button>
          </div> 
        </div>
