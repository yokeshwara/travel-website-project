  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="container mx-auto px-4 max-w-3xl py-8 md:py-12 lg:py-16">
        {/* Article Title */}
        <h1 className="text-3xl md:text-4xl lg:text-4xl font-semibold mb-4 text-balance" style={{ fontFamily: "Urbanist" }}>
          Checking In: Exploring the Intersection of Hotels and Travel
        </h1>

        <p className="text-gray-500 text-sm mb-8" style={{ fontFamily: "Urbanist" }}>April 24, 2024</p>
        ...
        <article className="prose prose-gray max-w-none">
          ...
          <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 mb-4 mt-8" style={{ fontFamily: "Urbanist" }}>
          ...
          <p className="text-gray-700 leading-relaxed mb-8" style={{ fontFamily: "Urbanist" }}>
        ...
        {/* Comments Section */}
        <div className="mb-12">
          <h3 className="text-lg font-medium text-gray-600 mb-4" style={{ fontFamily: "Urbanist" }}>Join the conversation</h3>
